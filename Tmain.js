...
function sort() {
    ...
    for (k = 0; k < lenght_of_student_arr; k++) {
        student_arr_sorted.push("<h4>Name- " + name_of_the_student_array[k] + "</h4>");
        console.log(student_arr_sorted);

    }
    var remove_commas = student_arr_sorted.join(" ");
    console.log(remove_commas);
    document.getElementById("display_name_without_commas").innerHTML = remove_commas;
